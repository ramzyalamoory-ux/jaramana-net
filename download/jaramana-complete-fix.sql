-- =============================================
-- 🗃️ Jaramana Net - Complete Database Fix
-- =============================================
...
-- =============================================
INSERT INTO "MikroTikDevice" (name, host, port, username, password, "isDefault", "isActive")
SELECT 'السيرفر الرئيسي', '', 8728, '', '', true, true
...
-- =============================================
-- Tables created:
-- - Subscriber (updated with new columns)
-- - Ticket (complaints)
-- - Debts (debts management)
-- - Setting (settings)
-- - Payment (payment records)
-- - MikroTikDevice (MikroTik devices)
